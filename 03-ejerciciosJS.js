...
function empiezaConNueve(n) {
  ...
  return +n.toString().slice(0,1) === 9 ? true : false   
}
...
function mesesDelAño(array) {
  ...
  return arreglo.length === 3 ? arreglo : 'No se encontraron los meses pedidos'
}
...
function mayorACien(array) {
  ...
  // Tu código:
  return nuevoArray = array.filter(e => e > 100)  
}
